class Kit::ProductsController < ApplicationController
  before_action :set_kit_product, only: %i[ show edit update destroy ]
  ...
  def create
    ...
    respond_to do |format|
      if @kit_product.save
        format.html { redirect_to @kit_product, notice: "Product was successfully created." }
  ...
  def update
    respond_to do |format|
      if @kit_product.update(kit_product_params)
        format.html { redirect_to @kit_product, notice: "Product was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to kit_products_path, status: :see_other, notice: "Product was successfully destroyed." }
